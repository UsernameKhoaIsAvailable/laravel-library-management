        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td class="border border-gray-300 py-2 flex space-x-2 justify-center">
                            <div class="px-1">
                                <x-secondary-button x-data="" x-on:click.prevent="$dispatch('open-modal', '{{'book'.(string)$index}}')">
            ...
            <x-modal name="{{'book'.(string)$index}}">
                <form method="post" action="{{ route('books.update', $book)}}" class="p-6">
                    ...
                    <div class="mt-6">
                        ...
                        <x-text-input id="category" name="category" type="text" class="mt-1 block w-full" :value="old('category', $book->category)" required autofocus autocomplete="category" />
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <x-text-input id="language" name="language" type="text" class="mt-1 block w-full" :value="old('language', $book->language)" required autofocus autocomplete="language" />
                    </div>

                    <div class="mt-6">
                        <x-input-label for="quantity" :value="__('Quantity')" />
                        <x-text-input id="quantity" name="quantity" type="text" class="mt-1 block w-full" :value="old('quantity', $book->quantity)" required autofocus autocomplete="quantity" />
                    </div>
            ...
            <x-modal name="add-book">
                <form method="post" action="{{ route('books.store')}}" class="p-6">
                    ...
                    <div class="mt-6">
                        <x-input-label for="category" :value="__('Category')" />
                        <x-text-input id="category" name="category" type="text" class="mt-1 block w-full" autofocus autocomplete="category" />
                    </div>

                    <div class="mt-6">
                        <x-input-label for="author" :value="__('Author')" />
                        <x-text-input id="author" name="author" type="text" class="mt-1 block w-full" autofocus autocomplete="author" />
                    </div>

                    <div class="mt-6">
                        <x-input-label for="language" :value="__('Language')" />
                        <x-text-input id="language" name="language" type="text" class="mt-1 block w-full" autofocus autocomplete="language" />
                    </div>
