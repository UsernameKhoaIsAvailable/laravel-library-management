                            ...
                            <td class="border border-gray-300 py-2 flex space-x-2 justify-center">
                                <div class="px-1">
                                    <x-secondary-button x-data=""
                                        x-on:click.prevent="$dispatch('open-modal', '{{'reader' . (string) $index}}')">
                    ...
                    <form method="post" action="{{ route('readers.update', $reader)}}" class="p-6">
                        ...
                        <div class="mt-6">
                            ...
                            <x-text-input id="dob" name="dob" type="date" class="mt-1 block w-full"
                                value="{{ old('dob', $reader->dob->format('Y-m-d')) }}" required />
                            @error('dob')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <x-text-input id="id_number" name="id_number" type="text" pattern="[0-9]{10}" maxlength="10"
                                class="mt-1 block w-full" :value="old('id_number', $reader->id_number)" required autofocus
                        ...
                        <div class="mt-6">
                            ...
                            <x-text-input id="address" name="address" type="text" class="mt-1 block w-full"
                                :value="old('address', $reader->address)" required autofocus autocomplete="address" />
                        </div>
            ...
            <x-modal name="add-reader">
                <form method="post" action="{{ route('readers.store')}}" class="p-6">
                    ...
                    <div class="mt-6">
                        <x-input-label for="id_number" :value="__('Id number')" />
                        <x-text-input id="id_number" name="id_number" type="text" pattern="[0-9]{10}" maxlength="10"
                            class="mt-1 block w-full" required autofocus autocomplete="id_number" />
                    </div>
